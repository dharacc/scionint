...
function ciyashop_show_shop_sidebar() {
	...
	if ( function_exists( 'is_shop' ) && is_shop() ) {
		if ( ( isset( $ciyashop_options['off_canvas_shop_sidebar'] ) && $ciyashop_options['off_canvas_shop_sidebar'] ) && ( isset( $ciyashop_options['shop_sidebar'] ) && 'no' !== $ciyashop_options['shop_sidebar'] ) ) {
			?>
			<div class="ciyashop-show-shop-sidebar">
				<a class="ciyashop-show-shop-btn"href="#"><i class="fas fa-bars" aria-hidden="true"></i><?php esc_html_e( 'Show sidebar', 'ciyashop' ); ?></a>
			</div>
			<?php
		}
	}
