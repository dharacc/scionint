...
function ciyashop_shop_categories_header_css( $ciyashop_options ) {
	...
	if ( ( isset( $ciyashop_options['shop_categories_style'] ) && 'style-1' !== $ciyashop_options['shop_categories_style'] ) && ( function_exists( 'is_shop' ) && is_shop() ) ) {

		if ( isset( $ciyashop_options['shop_categories_background'] ) && ! empty( $ciyashop_options['shop_categories_background'] ) ) {

			if ( isset( $ciyashop_options['shop_categories_background']['background-image'] ) && ! empty( $ciyashop_options['shop_categories_background']['background-image'] ) ) {
				$banner_image_bg_url = $ciyashop_options['shop_categories_background']['background-image'];
				$dynamic_css['.woocommerce-categories-slider']['background-image'] = 'url(\'' . $banner_image_bg_url . '\')';
			}
			if ( isset( $ciyashop_options['shop_categories_background']['background-repeat'] ) && ! empty( $ciyashop_options['shop_categories_background']['background-repeat'] ) ) {
				$dynamic_css['.woocommerce-categories-slider']['background-repeat'] = $ciyashop_options['shop_categories_background']['background-repeat'];
			}
			if ( isset( $ciyashop_options['shop_categories_background']['background-size'] ) && ! empty( $ciyashop_options['shop_categories_background']['background-size'] ) ) {
				$dynamic_css['.woocommerce-categories-slider']['background-size'] = $ciyashop_options['shop_categories_background']['background-size'];
			}
			if ( isset( $ciyashop_options['shop_categories_background']['background-attachment'] ) && ! empty( $ciyashop_options['shop_categories_background']['background-attachment'] ) ) {
				$dynamic_css['.woocommerce-categories-slider']['background-attachment'] = $ciyashop_options['shop_categories_background']['background-attachment'];
			}
			if ( isset( $ciyashop_options['shop_categories_background']['background-position'] ) && ! empty( $ciyashop_options['shop_categories_background']['background-position'] ) ) {
				$dynamic_css['.woocommerce-categories-slider']['background-position'] = $ciyashop_options['shop_categories_background']['background-position'];
			}
			if ( isset( $ciyashop_options['shop_categories_background']['background-color'] ) && ! empty( $ciyashop_options['shop_categories_background']['background-color'] ) ) {
				$dynamic_css['.woocommerce-categories-slider']['background-color'] = $ciyashop_options['shop_categories_background']['background-color'];
			}
		}
	}
}
