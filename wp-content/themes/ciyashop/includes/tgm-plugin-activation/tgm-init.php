	...
	return apply_filters(
		...
		array(
			array(
				...
				'slug'               => 'pgs-core',
				'source'             => ciyashop_tgmpa_plugin_path( 'pgs-core-4.8.0.zip' ),
				'required'           => true,
			...
			array(
				...
				'slug'               => 'js_composer',
				'source'             => ciyashop_tgmpa_plugin_path( 'js_composer-6.5.0.zip' ),
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false,
				'version'            => '6.5.0',
			...
			array(
				...
				'slug'               => 'revslider',
				'source'             => ciyashop_tgmpa_plugin_path( 'revslider-6.3.5.zip' ),
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false,
				'version'            => '6.3.5',
