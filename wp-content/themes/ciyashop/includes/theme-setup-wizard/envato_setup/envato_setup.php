...
if ( ! class_exists( 'Envato_Theme_Setup_Wizard' ) ) {
	...
	class Envato_Theme_Setup_Wizard {
		...
		public function is_plugin_check_active( $slug ) {
			...
			return ( ( ! empty( $instance->plugins[ $slug ]['is_callable'] ) && is_callable( $instance->plugins[ $slug ]['is_callable'] ) ) || ciyashop_check_plugin_active( $instance->plugins[ $slug ]['file_path'] ) );
		}
		...
		public function envato_setup_default_content() {
			...
			<form method="post">
				...
				<input type="hidden" name="import-id" id="import-id" value="default">
