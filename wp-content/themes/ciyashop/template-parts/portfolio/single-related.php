...
<section class="related-portfolio">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<div class="section-title"><h2 class="title"><?php echo esc_html( $ciyashop_options['related_portfolio_title'] ); ?></h2></div>
									...
									<div class="project-info">
										<div class="project-image">
											...
											<div class="portfolio-control">
												...
												<a href="<?php the_post_thumbnail_url( 'full' ); ?>" class="button popup-link popup-img"><i class="fa fa-arrows-alt"></i></a>
											</div>
										</div>
										<div class="overlay">
