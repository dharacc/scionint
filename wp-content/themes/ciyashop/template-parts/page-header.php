...
if ( function_exists( 'ciyashop_is_woocommerce_page' ) && ciyashop_is_woocommerce_page() ) {
	...
	if ( ( $show_header_on_shop_page && is_shop() ) || ( $show_header_on_product_single_page && is_product() ) || ( $show_header_on_shop_page && is_product_category() ) || is_product_tag() || is_checkout() || is_account_page() ) {
		?>
