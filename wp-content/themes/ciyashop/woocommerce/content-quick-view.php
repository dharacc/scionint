...
<div itemscope id="product-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>
	...
	<div class="row align-items-center product-image-summary">
		<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 product-images">
			<?php
		...
		<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 summary entry-summary">
