...
Version: 3.8
Author: Crivion
Author URI: https://crivion.com
*/

/* Logging utilities */
function wpgeoip_add_log($action, $message) {

  if( get_option( 'wpgeoip_logging', 'No' ) == 'Yes' ) {
  	global $wpdb;
...
function geoip_admin_menu() {
        ...
        add_submenu_page('wpgeoip-admin', 'WPGeoIP Validation', 'WPGeoIP Validation', 'manage_options', 'wpgeoip-license' ,'wpgeoip_autoupdate'); 
