...
= 2.0.3 - Released on 31 December 2020 =
New: Support for WooCommerce 4.8
Update: Plugin framework
Fix: Fixed the total amount recovered on report page

= 2.0.2 - Released on 3 December 2020 =
New: Support for WooCommerce 4.8
Update: Plugin framework
Fix: Added missing 4th parameter in WooCommerce Email Header do action

= 2.0.1 - Released on 6 November 2020 =
New: Support for WordPress 5.6
New: Support for WooCommerce 4.7
Fix: Fixed pending order emails were not being sent if "Enable cart recovery" option is disabled.

= 2.0.0 - Released on 14 October 2020 =
New: UI design
New: minutes/hours/days selectors
New: Redesigned reports style on Dashboard tab
New: Improved Email Templates design
New: Placeholder {{ywrac.recoverbutton}} for the Recover Button
Tweak: Activate/deactivate the Email Templates status from the Email Templates list
Tweak: Email Templates sample created automatically by default
Fix: Recovered Pending Order stats added as Abandoned Carts
Update: Plugin framework
Update: Language files

= 1.4.7 -  Released on 13 October 2020 =
New: Support for WooCommerce 4.6
Update: Plugin framework
Fix: Fixed WooCommerce deprecated functions

= 1.4.6 -  Released on 17 September 2020 =
New: Support for WooCommerce 4.5
New: Support for WordPress 5.5
Update: Plugin framework

= 1.4.5 -  Released on 7 July 2020 =
