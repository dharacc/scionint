...
<div style="width:99%;overflow:hidden;" class="pieregister-admin">
  <div class="right_section">
    <div class="pie_wrap">
      ...
      <form method="post" id="formeditor">
        ...
        <fieldset>
          ...
          <div id="hint_1" class="fields_hint" style="left: 95%;top: 50%; z-index:2;"> <img src="<?php echo plugins_url('pie-register-premium'); ?>/assets/images/left_arrow.jpg" width="45" height="26" align="left">
    ...
    <div class="right_menu">
      <div id="hint_0" style="top: 135px;margin-left: -271px;position: fixed;float:right;" class="fields_hint"> <img src="<?php echo plugins_url('pie-register-premium'); ?>/assets/images/right_arrow.jpg" width="45" height="26" align="right">
        <div class="hint_content">
          <h4>
            <?php _e("Did you know?","pie-register"); ?>
          </h4>
