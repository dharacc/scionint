            ...
            <div class="wrapper-forms">
                ...
                <?php
                    ...
                    if(PIEREG_IS_ACTIVE){
                        ...
                        $status  = get_option('piereg_api_manager_PR_Premium_status');
                        if( $status == "inactive" ){
                        ?>
                            <div class="licese_expiry_msg">
                                <?php _e('Your Pie Register Premium License key has expired.  Please <a href="https://blue.genetechz.com/store_gene/renew-order/">renew</a> your order to get all the plugin updates and support.','pie-register') ?> 
                            </div> 
                        <?php 
                        } 
                        ?>
