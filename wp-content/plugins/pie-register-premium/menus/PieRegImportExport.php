        ...
        <div class="fields">
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="file_container">
              ...
              <span class="quotation"><?php echo sprintf( __( 'You may want to see', 'pie-register').' <a target="_blank" download href="%s"> '.__('this example of the CSV file.', 'pie-register').'</a>.' , plugins_url('pie-register-premium').'/menus/examples/example-invitaion-codes.csv'); ?></span>
            </div>
          </form>
        </div>
      </fieldset>
            ...
            <li>
              <div class="fields date">
                ...
                <div class="start_date">
                  ...
                  <img id="start_icon" src="<?php echo plugins_url('pie-register-premium'); ?>/assets/images/calendar_img.jpg" width="22" height="22" alt="calendar" class="calendar_img" /> </div>
                <div class="end_date">
                  <label for="field_">
                    <?php _e("End","pie-register"); ?>
                  </label>
                  <input id="date_end" name="date_end" type="text" class="input_fields date_start" />
                  <img id="end_icon" src="<?php echo plugins_url('pie-register-premium'); ?>/assets/images/calendar.png" width="22" height="22" alt="calendar" class="calendar_img" /> </div>
      ...
      <div class="import">
        <form method="post" action="" enctype="multipart/form-data">
          ...
          <ul>
            ...
            <li>
              <div class="fields"> <span style="float:left"><?php echo sprintf( __( 'You may want to see', 'pie-register').' <a target="_blank" download href="%s"> '.__('this example of the CSV file.', 'pie-register').'</a>.' , plugins_url('pie-register-premium').'/menus/examples/example.csv'); ?></span>
                <div class="piereg_clear"></div>
              </div>
            </li>
            <li>
