...
Have an exclusive site? Let users register only when you send them an invitation code. Protect your site's privacy and prevent unwanted registrations by easily setting invitation codes by defining limit usage. Specify the Invitation Codes from the Field settings to allow registration on a particular form through these codes only.
...
**[Auto-Generate Password](https://pieregister.com/features/auto-generate-password/)**
Pie Register lets you enable the Auto-generated passwords for your registration forms. Strong passwords are randomly generated that are difficult to hack for an extra secure login process.

**[Custom Redirection](https://pieregister.com/features/custom-redirection/)**
Choose where to Redirect the Users after Registration and Login.
...
**[Auto-Login After Registration](https://pieregister.com/features/auto-login-after-registration/)**
With Pie Register Premium, you can enable the Auto-Login after Registration. This will allow your users to directly log-in as soon as they register for quick access to your website.
...
**[BBPress Addon](https://pieregister.com/addons/bbpress-addon/)**
...
### 3.6.8
* Updated: Charecter length restriction in the name field settings
