...
function pie_edit_userdata($form_id = "default"){
	...
	$profile_fields_data = "";
	$query_url = remove_query_arg( array('pr_msg','type'), $_SERVER['REQUEST_URI'] );
	$profile_fields_data .= '<div class="pieregProfileWrapper pieregWrapper">
	<form enctype="multipart/form-data" id="pie_regiser_form" method="post" action="'.htmlentities($query_url).'">';
