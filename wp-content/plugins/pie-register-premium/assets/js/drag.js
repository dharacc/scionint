...
// wc_billing_address check -- pie-register WooCommerce
    ...
    piereg(".next_button").on("change", function() {
    ...
    piereg(".prev_button").on("change", function() {
    ...
    piereg("ul.controls li a.default").on("click", function() {
    ...
    piereg(".hide_state").on("change", function() {
