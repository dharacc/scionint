...
[Documentation](https://accesspressthemes.com/documentation/ap-mega-menu/) | [Support](https://accesspressthemes.com/support) | [Demo](http://demo.accesspressthemes.com/wordpress-plugins/ap-mega-menu/) | [Videos Tutorials](https://www.youtube.com/playlist?list=PLdSqn2S_qFxHLWS_ZcuGGh1SyWGP_llug) | [Premium Version](https://accesspressthemes.com/wordpress-plugins/wp-mega-menu-pro/)
...
* Removed the setting to add custom css and js(deprecated).

= 3.0.5 =
* Made necessary code refinement and updated js libraries.
...
= 3.0.2 =
* Fixed frontend issue on selecting default theme

= 3.0.1 =
* Checked compatibility with the latest WordPress version
* Fixed selectbox js issue
* Did necessary code refinement

= 3.0.0 =
* Fixed error message shown in the frontend

= 2.0.9 =
* Tested with the latest version of WP

= 2.0.8 =
* Error message shown on plugin activation issue fixed.
