				...
				<div id="poststuff">
					<div id="post-body" class="metabox-holder columns-2">
						...
						<form class="apmm-theme-form" action="<?php echo admin_url('admin-post.php');?>" method="post">
							...
							<input type="hidden" name="themeid" value="<?php echo (!isset($_GET['theme_id']))?'':(intval($_GET['theme_id'])); ?>"/>
							<input type="hidden" name="_nonce" value="<?php echo (!isset($_GET['_wpnonce']))?'':esc_attr($_GET['_wpnonce']); ?>"/>
